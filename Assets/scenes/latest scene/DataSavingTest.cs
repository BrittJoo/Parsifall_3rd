...
public class DataSavingTest : MonoBehaviour {
    ...
    public void SaveData(string characterOne, string characterTwo, string characterThree, string characterFour, string characterFive, string characterSix,
        int characterOneScore, int characterTwoScore, int characterThreeScore, int characterFourScore, int characterFiveScore, int characterSixScore,
