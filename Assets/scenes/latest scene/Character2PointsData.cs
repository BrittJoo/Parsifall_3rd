...
public class Character2PointsData   {

    public string classSatement;
    ...
    public Character2PointsData(string statement, int awnserValue1, int awnserValue2, int awnserValue3, int awnserValue4)
    {
